Below is a more detailed, step-by-step guide that you can share with your colleagues. It provides an expanded explanation of each action, the reasoning behind them, and potential best practices to ensure a smooth setup.
